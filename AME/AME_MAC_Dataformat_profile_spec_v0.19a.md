...
>
> - History : 
>   - Oct.16, 2025 Adds Elementwise ACC datatype I32,F32 on baseline -  v0.19a
...
| 3     | **INT8→INT32**, **FP8→FP32**  | **INT8→INT32**, **FP8→FP32**  | **INT32->INT64**, **FP32->FP64** | -            | -             |
| 4     | -            | -              | -              | -            | -             |
| 5     | -            | -              | -              | -            | -             |
...
- So, Nvidia TF32 multiplier kernel will do some arbitrary bits for increasing precision, it may be evaluated using FP22.
